...
/**
 * Throwdownâ€‘style starter UI (no seeded demo data).
 ...
 * - Includes an â€œExportâ€ panel with copyâ€‘paste files to deploy to GitHub Pages (Vite + React).
 *
 * Notes:
...
const DIVISIONS = ["RX", "Scaled", "Intermediate", "Masters", "Teens", "Adaptive", "All"];
        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <CardDescription className="mt-1 text-xs text-white/60">
              {formatHumanDate(evt.date)}{evt.city ? ` Â· ${evt.city}` : ""}{evt.region ? ` Â· ${evt.region}` : ""}
            </CardDescription>
          </div>
      ...
      <CardContent className="pt-0">
        ...
        <div className="mt-4 flex items-center justify-between">
          <div className="text-xs text-white/55">
            ...
            {evt.organiser ? (evt.price ? " Â· " : "") + `Organiser: ${evt.organiser}` : ""}
          </div>
      ...
      <DialogContent className="border-white/10 bg-zinc-950 text-white sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription className="text-white/60">
            {evt ? `${formatHumanDate(evt.date)}${evt.city ? ` Â· ${evt.city}` : ""}${evt.venue ? ` Â· ${evt.venue}` : ""}` : ""}
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
              <Card className="border-white/10 bg-white/5">
                <CardContent className="p-4">
                  ...
                  <p className="mt-1 text-sm text-white/85">{evt.region || "â€”"}</p>
                </CardContent>
              </Card>
              <Card className="border-white/10 bg-white/5">
                <CardContent className="p-4">
                  <p className="text-xs text-white/60">Entry</p>
                  <p className="mt-1 text-sm text-white/85">{evt.price || "â€”"}</p>
                </CardContent>
              </Card>
            </div>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div className="space-y-2 md:col-span-2">
            ...
            <textarea
              ...
              placeholder="A short description that sells the vibe, standards, and formatâ€¦"
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-2xl border border-white/10 bg-black/30 p-3 text-xs text-white/65">
              ...
              <ol className="mt-2 list-decimal space-y-1 pl-5">
                ...
                <li>In GitHub: Settings â†’ Pages â†’ set Source to <span className="text-white/80">GitHub Actions</span>.</li>
                <li>Wait for the Actions workflow â€œDeploy to GitHub Pagesâ€ to go green.</li>
              </ol>
            </div>
          </div>
...
export default function ThrowdownStyleStarter() {
  ...
  const deleteEvent = (evt) => {
    if (!evt) return;
    const ok = confirm(`Delete â€œ${evt.name}â€? This only removes it from your browser storage.`);
    if (!ok) return;
  ...
  const clearAll = () => {
    const ok = confirm("Clear all events stored in this browser? (This wonâ€™t affect any server, itâ€™s just local.)");
    if (!ok) return;
    setEvents([]);
  };
    ...
    <div className="min-h-screen bg-[#07070a] text-white">
          ...
          <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-white/65">
                A clean, dark, neon-accent competition calendar â€” designed for quick scanning like an event hub.
            ...
            <div className="md:col-span-6">
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="Search events, cities, organisers, tagsâ€¦"
      ...
      <main className="mx-auto max-w-6xl px-4 pb-16 pt-8">
                          ...
                          >
                            <div className="flex items-start justify-between gap-3">
                              <div>
                                ...
                                <p className="mt-1 text-xs text-white/55">{evt.city ? `${evt.city} Â· ` : ""}{evt.region || ""}</p>
                              </div>
        ...
        <footer className="mt-10 text-center text-xs text-white/45">
          <p>
            Prototype only â€” built to share a look & feel. Replace local storage with a real backend when you move beyond a temp page.
          </p>
        </footer>
      </main>
    </div>
